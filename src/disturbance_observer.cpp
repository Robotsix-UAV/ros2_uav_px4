...
int main(int argc, char * argv[])
{
  ...
  auto callback =
    [&disturbance_observer, time_init,
  ...
  auto callback_setpoint =
    [&disturbance_observer, time_init, &disturbance_node,
  ...
  auto disturbance_callback =
    [&disturbance_pub](const Vec3 & constant_disturbance, const Vec3 & proportional_disturbance) {
